<template>
  <div id="home">
    <Map :id="'map'" ref="map" />
    <div class="left">
      <AreaCountA ref="area_count_a" class="module" :count="areaCount" />
      <AreaCountB ref="area_count_b" class="module" :count="areaCount" />
      <AreaCountC ref="area_count_c" class="module" :count="areaCount" />
      <AlarmCount ref="alarm_count" class="module" />
    </div>
    <div class="top">
      <div class="main-title">
        <img :src="title.logo" class="main-title-logo">
    ...
    <div class="right">
      <AlarmFactory class="module" />
      <AlarmPoint ref="alarm_point" class="module" />
    </div>
    <div class="iconfont icon-close" @click="closeClick()" />
  </div>
</template>
...
export default {
  name: 'Home',
  components: {
    AreaCountA, AreaCountB, AreaCountC, AlarmCount,
    Map, Info,
    AlarmFactory, AlarmPoint
  },
  data() {
    return {
      title: { text: '新视智科温度监测系统', logo: require('@/assets/logo.svg') },
      updateTime: '',
      areaCount: 6
    }
  },
